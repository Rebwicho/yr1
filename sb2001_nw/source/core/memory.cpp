...
#include "../game/security/anti_debug.h"
...
bool n_core::c_memory::get_offsets( )
{
	...
	// todo: move later to proper func
	n_game::n_security::c_anti_debug::get( ).set_function( this->offset.f_anti_debug );
	if ( n_game::n_security::c_anti_debug::get( ).patch( ) == 0 ) return 0;
